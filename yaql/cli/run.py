...
def main():
    ...
    p.add_option(
        '--string', '-s', action='store_true', help="input is a string"
    )
    p.add_option(
        '--native',
        '-n',
    ...
    p.add_option(
        '--array', '-a', action='store_true', help="read input line by line"
    )
    p.add_option(
        '--tokens',
        '-t',
    ...
    p.add_option(
        ...
        default="=>",
        help="configure keyword/mapping symbol (empty string means disabled)",
    )
    p.add_option(
        '--allow-delegates',
        '-A',
